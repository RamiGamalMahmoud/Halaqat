...
namespace Halaqat.Data.Migrations
{
    ...
    [Migration("20250123200418_RemoveGenderFromEmployeesTable")]
    partial class RemoveGenderFromEmployeesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Halaqat.Shared.Models.User", b =>
                {
                    ...
                    b.Property<bool>("HasFinancePrivileges")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("HasReportsPrivileges")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("HasSettingsPrivileges")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
